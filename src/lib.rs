// src/lib.rs
/*
 * Core library for IndexOptimizer
 */
...
#[derive(Debug)]
pub struct IndexOptimizerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl IndexOptimizerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting IndexOptimizer processing");
    
    let mut processor = IndexOptimizerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = IndexOptimizerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = IndexOptimizerProcessor::new(false);
